...
if __name__ =="__main__":
    ...
    #rand_val = np.random.uniform(45,50)
    #RTT_1 = [rand_val, rand_val, rand_val]
...
#        total_budget = 0
#        changer = 0
    while(RTT[0]!=10000 or RTT[1]!=10000 or RTT[2]!=10000):
#        for j in range(0,el):
    ...
    #    attack_vol = Firewall(attack_vol, 0.6)
        ...
        if((rounder % 5) is 0):     #Bohatei Implementation
            ...
            for ing in range(0,num_ingress):
                values[ing]=(values[ing]/sum_val)*ISP_Cap[ing]
                #print(values[ing])
            
            ISP_Cap = values
            
        RTT_randMix.append(max(RTT))
    ...
    print("DDOS in rounds {}".format(rounder))
        #budgeter.append(total_budget)
        #Rand_RTT_inc.append(changer/j)
    #print(statistics.mean(RTT_randMix))
    #print(Rand_RTT_inc) 
    #print(budgeter)       
